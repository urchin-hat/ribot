...
>>>    _- メンションが必要なもの(1on1なら不必要)_
        _完全一致じゃないと反応しないもの_
            _1) はろーと呟くと ハローワールドと返してくれるよー_
            _2) おにぎりはおにぎり_
        _完全一致じゃなくても反応してくれるもの_
            _チャンネル限定_
                _1) 選出 ○人と呟くとランダムで選出してくれるよー_
                _2) アンケート お題 項目1 項目2...と呟くとアンケートを作成するよー_
                _3) トピック 設定するトピックと呟くとトピックを設定するよー_


   _- メンションじゃなくても拾ってくれるもの(チャンネル限定)_
        _完全一致じゃないと反応しないもの_
            _1) お疲れ様ですと呟くと返してくれるよー_
            _2) {都市名}の天気と呟くと天気情報を教えてくれるよー_
            _3) BTCのレートと呟くとBTCの売値買値を教えてくれるよー_
            _4) 今日のおにぎりはおにぎり_

   _- どっちでも反応してくれるもの_
        _完全一致じゃないと反応しないもの_
            _1) 新書or 書籍or 新刊と呟くとオライリーの新書情報を教えてくれるよー_
            _2) ニュースと呟くとスラドの最新5件のニュースを教えてくれるよー_

   _それ以外はAR3TのTalk APIで塩対応してくれるよー_'''
    message.reply(text)
